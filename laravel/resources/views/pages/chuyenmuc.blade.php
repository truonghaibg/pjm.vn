        ...
        <div class='product'>
            ...
            <div class="sortby">
                <div class="sort_pro">
                    ...
                    <ul>
                        <li><a href="{{url('danh-sach/'.$cate2->cate_namekd.'/sapxep/sort=new')}}" rel="nofollow">Mới
                                nhất</a></li>
                        <li><a href="{{url('danh-sach/'.$cate2->cate_namekd.'/sapxep/sort=price-asc')}}" rel="nofollow">Giá:
                                thấp -&gt; cao</a></li>
                        <li><a href="{{url('danh-sach/'.$cate2->cate_namekd.'/sapxep/sort=price-desc')}}"
                               rel="nofollow">Giá: cao -&gt; thấp</a></li>
                        <li><a href="{{url('danh-sach/'.$cate2->cate_namekd.'/sapxep/sort=name')}}" rel="nofollow">Tên
                                A-&gt;Z</a></li>
                    </ul>
                </div>
