    ...
    <div class="container-fluid">
            ...
            <table class="table table-striped table-bordered table-hover" >
                ...
                <tbody>
                    <tr class="odd gradeX" align="center">
                        <td style="color:red; font-size:18px;"><?php echo e($totalpro); ?><a href="admin/product/list" target="_blank">(More)</a></td>
                        <td style="color:red; font-size:18px;"><?php echo e($totalorder); ?><a href="admin/order/list" target="_blank">(More)</a></td>
        ...
        <div class="row">
          ...
          <?php
           ...
           ?>
           <input type="hidden" id="dataProvider" value="<?php echo e(json_encode($data)); ?>">
