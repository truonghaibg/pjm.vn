    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="ghang">
                    <div id="guide_cart">
                        <img src="{{url('template_asset/images/site/cart/cart.png')}}" alt="" style="float:left">
                        <h1>Chi tiết giỏ hàng</h1>
                        <p>Để xóa sản phẩm khỏi giỏ hàng, bấm <img src="{{url('template_asset/images/site/cart/icon_del.png')}}" alt="">, để
                            mua thêm bấm <b>"Mua thêm sản phẩm khác"</b>.
                            Để sang bước đặt hàng tiếp theo, bấm <b>"Tiếp tục"</b>, để mua hàng trả góp bấm <b>"Mua trả góp"</b></p>
                    </div>
                    <form action="{{url('/update-cart')}}" method="POST">
                        <table style="margin-top: 10px;width: 100%; border-collapse: collapse;" id="tbl_list_cart" cellpadding="5"
                                    ...
                                    <td>
                                        ...
                                        <div style="margin-left:120px;">
                                            ...
                                            <p style="padding-top: 3px; color:red;font-weight: normal;text-transform: none;"
                                               class="red">Mã sản phẩm: <?php echo $row->options->model; ?></p>
                                            <p style="padding-top: 3px;font-weight: normal;text-transform: none;">Bảo hành: 12T</p>
                                        </div>
                                    </td>
                                    <td>
                                        <input type="text" name="qty[]" value="<?php echo $row->qty; ?>" size="3" id="mySelect"
                                               onchange="myFunction()">
                                    </td>
                                    <td><?php echo number_format($row->price); ?> đ
                                        <input type="text" id="demo_price" style="display:none;" value="{{$row->price}}"></td>
                                    <?php $item_total = ($row->qty) * ($row->price); ?>
                                    <td style="font-weight:bold"><?php echo number_format($row->total); ?> đ</td>
                                    <td>
                                        <a href="{{url('del-item/'.$row->rowId)}}" onclick="return kiemtra();">
                                            <img src="{{url('template_asset/images/site/cart/icon_del.png')}}">
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <tr>
                                <td colspan="3"></td>
                                <td colspan="3">Tổng tiền: <b style="color:red; font-size:17px;">
