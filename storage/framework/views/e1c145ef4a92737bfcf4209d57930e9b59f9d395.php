                    ...
                    <div class="form-group">
						<div class="form-group">
                            <label>Video>Ảnh</label>
								...
								?>
									<iframe width="300" height="216" src="https://www.youtube.com/embed/<?php echo e($code); ?>" frameborder="0" allowfullscreen></iframe>
								</div>
                            <input class="form-control" type="text" name="link" value="<?php echo e($video->link); ?>" />
                        </div>
